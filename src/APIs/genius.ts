...
export async function getReleaseDateFromGenius(trackName: string, artists: string): Promise<Date> {
    ...
    return new Date(`${track.release_date_components.year}-${track.release_date_components.month}-${track.release_date_components.day}`);
}
